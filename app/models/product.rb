class Product < ActiveRecord::Base
  ...
  attr_accessible :category_id,:sixty, :typ, :price, :sklad, :shortd, :title, :hundredzav, :fortyzav, :ninety, :artukyl, :astma, :eighteenzav, :forty, :twentyzav, :alerg, :thirty, :twenty, :ukrtitle, :seventyzav, :description
  belongs_to :category
